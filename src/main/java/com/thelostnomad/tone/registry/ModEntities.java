...
import com.thelostnomad.tone.entities.nature_sprite.RenderNatureSprite;
...
public class ModEntities {
    ...
    public static void initModels() {
        RenderingRegistry.registerEntityRenderingHandler(NatureSpriteEntity.class, RenderNatureSprite.FACTORY);
    }
